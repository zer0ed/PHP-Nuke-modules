...
var gsBottom="<A href='javascript:void(0)' class='Today' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Today is not a selectable date!\");return false;' onmouseover='return true;' title='Today'>Today : "+gToday[2]+" "+gMonths[gToday[1]-1]+" "+gToday[0]+"</A><br><br><input type='button' value='Clear' onclick='gdCtrl.value=\"0000-00-00\";fHideCal();if(this.blur)this.blur();return false;'><hr><span class='CalHead'>Powered By:<br><a href='http://www.calendarxp.net' target='_blank'>PopCalendarXP Lite</a></span>";	// the content of the bottom section.
...
var gcToggle="#AAFFAA";	// the highlight color for the focused cell
