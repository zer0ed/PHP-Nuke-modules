...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <td class="row1"> 
   <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr> 
     ...
     <td align="right"><span class="gen">[ <a href="{U_LOOKUP_IP}" class="gen">{L_LOOKUP_IP}</a>] &nbsp;</span></td>
    </tr>
   </table>
  </td>
 </tr>
 ...
 <tr> 
  <td class="{userrow.ROW_CLASS}"> 
   <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr> 
     <td>&nbsp;<span class="gen"><a href="{userrow.U_PROFILE}" class="gen">{userrow.USERNAME}</a> [ {userrow.POSTS} ]</span></td>
  ...
  <td class="{iprow.ROW_CLASS}">
   <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
     ...
     <td align="right"><span class="gen">[ <a href="{iprow.U_LOOKUP_IP}" class="gen">{L_LOOKUP_IP}</a> ]&nbsp;</span></td>
    </tr>
   </table>
  </td>
 </tr>
