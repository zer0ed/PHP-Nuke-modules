<form method="post" action="{S_POST_DAYS_ACTION}">
 ...
 <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
   ...
   <td class="row1" width="100%" onMouseOver="this.style.backgroundColor='#DEE3E7'; this.style.cursor='hand';" onMouseOut=this.style.backgroundColor="#CCCCCC" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
