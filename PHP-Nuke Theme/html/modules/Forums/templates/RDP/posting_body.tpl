      ...
      <td colspan="9">
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
         ...
         <td nowrap="nowrap" align="right"><span class="gensmall"><a href="javascript:bbstyle(-1)" class="genmed" onMouseOver="helpline('a')" class="gensmall">{L_BBCODE_CLOSE_TAGS}</a></span></td>
        </tr>
       </table>
      </td>
     </tr>
