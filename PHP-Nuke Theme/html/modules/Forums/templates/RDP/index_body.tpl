...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
 ...
 <tr> 
  ...
  <td class="row1" width="100%" onMouseOver="this.style.backgroundColor='#DEE3E7'; this.style.cursor='hand';" onMouseOut=this.style.backgroundColor="#CCCCCC" onclick="window.location.href='{catrow.forumrow.U_VIEWFORUM}'"> <span class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink">{catrow.forumrow.FORUM_NAME}</a></span><br />
