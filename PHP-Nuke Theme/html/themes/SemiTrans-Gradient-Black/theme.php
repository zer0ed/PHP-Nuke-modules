...
$textcolor1 = "#000000";
$textcolor2 = "#000000";
include("themes/SemiTrans-Gradient-Black/tables.php");
...
function themeheader() {
   ...
   if ($username == "Anonymous") {
      ...
      if ($msgnum > "0") {
         $msgsound = "\n\n<bgsound src=\"themes/SemiTrans-Gradient-Black/sounds/newmsg.wav\">";
      } else {
         $msgsound = "";
      }
   }
   ...
   if ( inAgent('MSIE') or inAgent('Opera') ) {
      $tmpl_file = "themes/SemiTrans-Gradient-Black/header.html";
   } elseif ( inAgent('Mozilla/4') ) {
      $tmpl_file = "themes/SemiTrans-Gradient-Black/ns4_header.html";
   } else {
      $tmpl_file = "themes/SemiTrans-Gradient-Black/header.html";
   }
   ...
   print $r_file;
   blocks(left);
   $tmpl_file = "themes/SemiTrans-Gradient-Black/left_center.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
...
function themefooter() {
   ...
   if ($index == 1) {
      $tmpl_file = "themes/SemiTrans-Gradient-Black/center_right.html";
      $thefile = implode("", file($tmpl_file));
      $thefile = addslashes($thefile);
      $thefile = "\$r_file=\"".$thefile."\";";
      eval($thefile);
   ...
   $tmpl_file = "themes/SemiTrans-Gradient-Black/footer.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
   ...
   $tmpl_file = "themes/SemiTrans-Gradient-Black/story_home.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
...
function themerouters ($rid, $rname, $rauthorname, $rauthoremail, $rsitename, $rsiteurl, $rtime, $rcost, $rsoft, $rcpu, $rram, $rif1, $rif2, $rif3, $rhub, $rdrives, $rnote, $vote_total, $vote_avg, $mainpic, $morepicslink, $detailslink, $voteslink) {
   ...
   $tmpl_file = "themes/SemiTrans-Gradient-Black/routers.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
   ...
   $tmpl_file = "themes/SemiTrans-Gradient-Black/story_page.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
...
function themesidebox($title, $content) {
   $tmpl_file = "themes/SemiTrans-Gradient-Black/blocks.html";
   $thefile = implode("", file($tmpl_file));
   $thefile = addslashes($thefile);
   $thefile = "\$r_file=\"".$thefile."\";";
   eval($thefile);
